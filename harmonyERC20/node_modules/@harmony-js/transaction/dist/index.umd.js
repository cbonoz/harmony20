...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@harmony-js/utils'), require('@harmony-js/crypto'), require('@harmony-js/network')) :
    typeof define === 'function' && define.amd ? define(['exports', '@harmony-js/utils', '@harmony-js/crypto', '@harmony-js/network'], factory) :
    (factory((global.harmonyTransaction = {}),global['@harmony-js/utils'],global['@harmony-js/crypto'],global['@harmony-js/network']));
}(this, (function (exports,utils,crypto,network) { 'use strict';

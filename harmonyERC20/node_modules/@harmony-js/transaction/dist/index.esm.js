...
import { decode, encode, keccak256, hexlify, BN, hexZeroPad, recoverAddress, getAddress, sign, HarmonyAddress, arrayify, stripZeros, splitSignature, getContractAddress } from '@harmony-js/crypto';
...
var recover = function (rawTransaction) {
    ...
    if (new BN(strip0x(handleNumber(tx.signature.r))).isZero() &&
...
var TransactionBase = /** @class */ (function () {
    ...
    TransactionBase.normalizeAddress = function (address) {
        ...
        else if (HarmonyAddress.isValidChecksum(address) ||
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        newBlock = _a.sent();
                        nextBlock = checkBlock.add(new BN(attempt === 0 ? attempt : 1));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new BN(currentBlock.result.replace('0x', ''), 'hex')];
                    case 2:
                        error_2 = _a.sent();
                        throw error_2;
    ...
    TransactionBase.prototype.socketCxConfirm = function (txHash, maxAttempts, toShardID) {
        ...
        if (maxAttempts === void 0) { maxAttempts = 20; }
        return new Promise(function (resolve, reject) {
            var newHeads = Promise.resolve(new NewHeaders(_this.messenger, typeof toShardID === 'string' ? Number.parseInt(toShardID, 10) : toShardID));
            newHeads.then(function (p) {
                p.onData(function (data) { return __awaiter(_this, void 0, void 0, function () {
                    var blockNumber;
                    return __generator(this, function (_a) {
...
var Transaction = /** @class */ (function (_super) {
    ...
    Transaction.prototype.getRLPUnsigned = function () {
        ...
        fields.forEach(function (field) {
            ...
            value = arrayify(hexlify(field.transform === 'hex' ? add0xToString(value.toString(16)) : value));
            // Fixed-width field
...
var TransactionFactory = /** @class */ (function () {
    ...
    TransactionFactory.getContractAddress = function (tx) {
        ...
        return getAddress(getContractAddress(getAddress(from).checksum, Number.parseInt("" + nonce, 10))).checksum;
    };

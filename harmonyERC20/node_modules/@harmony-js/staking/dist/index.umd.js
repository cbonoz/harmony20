...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@harmony-js/crypto'), require('@harmony-js/network'), require('@harmony-js/transaction'), require('@harmony-js/utils'), require('text-encoding')) :
    typeof define === 'function' && define.amd ? define(['exports', '@harmony-js/crypto', '@harmony-js/network', '@harmony-js/transaction', '@harmony-js/utils', 'text-encoding'], factory) :
    (factory((global.harmonyStaking = {}),global['@harmony-js/crypto'],global['@harmony-js/network'],global['@harmony-js/transaction'],global['@harmony-js/utils'],global['text-encoding']));
}(this, (function (exports,crypto,network,transaction,utils,textEncoding) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var StakingTransaction = /** @class */ (function (_super) {
        ...
        function StakingTransaction(directive, stakeMsg, nonce, gasPrice, gasLimit, chainID, messenger, txStatus) {
            ...
            if (txStatus === void 0) { txStatus = transaction.TxStatus.INTIALIZED; }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.messenger.send(network.RPCMethod.SendRawStakingTransaction, this.rawTransaction, this.messenger.chainType, this.messenger.currentShard)];
                        case 1:
                            res = _a.sent();
                            if (res.isResult()) {
                                this.id = res.result;
                                this.emitTransactionHash(this.id);
                                this.setTxStatus(transaction.TxStatus.PENDING);
                                return [2 /*return*/, [this, res.result]];
                            }
                            else if (res.isError()) {
                                this.emitConfirm("transaction failed:" + res.error.message);
                                this.setTxStatus(transaction.TxStatus.REJECTED);

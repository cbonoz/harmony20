...
import { arrayify, encode, hexlify, keccak256, sign, splitSignature, stripZeros } from '@harmony-js/crypto';
...
var StakingTransaction = /** @class */ (function (_super) {
    ...
    function StakingTransaction(directive, stakeMsg, nonce, gasPrice, gasLimit, chainID, messenger, txStatus) {
        ...
        if (txStatus === void 0) { txStatus = TxStatus.INTIALIZED; }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.messenger.send(RPCMethod.SendRawStakingTransaction, this.rawTransaction, this.messenger.chainType, this.messenger.currentShard)];
                    case 1:
                        res = _a.sent();
                        if (res.isResult()) {
                            this.id = res.result;
...
var StakingFactory = /** @class */ (function () {
    ...
    StakingFactory.prototype.build = function () {
        ...
        return new StakingTransaction(this.directive, this.stakeMsg, this.nonce !== undefined ? this.nonce : 0, this.gasPrice !== undefined ? this.gasPrice : new Unit('100').asGwei().toHex(), this.gasLimit !== undefined ? this.gasLimit : new Unit('210000').asWei().toHex(), this.chainId !== undefined ? this.chainId : 1, this.messenger, "INITIALIZED" /* INTIALIZED */);
    };

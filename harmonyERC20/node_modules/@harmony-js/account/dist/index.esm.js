...
import { isPrivateKey, add0xToString, hexToNumber, AddressSuffix, isAddress, ChainType, HDPath, isHttp, isWs, Unit, isHex } from '@harmony-js/utils';
 ...
 * @hidden
 */
var defaultMessenger = new Messenger(new HttpProvider('http://localhost:9500'), "hmy" /* Harmony */, 2 /* HmyLocal */);
    ...
    Account.prototype.toFile = function (password, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.privateKey && isPrivateKey(this.privateKey))) return [3 /*break*/, 2];
                        return [4 /*yield*/, encrypt(this.privateKey, password, options)];
                    case 1:
                        file = _a.sent();
...
var Wallet = /** @class */ (function () {
    ...
    Wallet.prototype.addByMnemonic = function (phrase, index) {
        ...
        var path = this.messenger.chainType === ChainType.Harmony ? '1023' : '60';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(foundAcc && foundAcc.privateKey && isPrivateKey(foundAcc.privateKey))) return [3 /*break*/, 2];
...
var HDNode = /** @class */ (function () {
    function HDNode(provider, menmonic, index, addressCount, shardID, chainType, chainId, gasLimit, gasPrice) {
        ...
        this.addresses = [];
        this.wallets = {};
        this.path = chainType === "hmy" /* Harmony */ ? HDPath : "m/44'/60'/0'/0/";
        this.index = index;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        tx = new Transaction(__assign(__assign({}, txParams), { from: from,
                            to: to,
                            gasLimit: gasLimit,
                            gasPrice: gasPrice,
                            value: value,
...
export { Account, Wallet, defaultMessenger, HDNode };

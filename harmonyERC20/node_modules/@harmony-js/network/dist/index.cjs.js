        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this.connected) {
                try {
                    ...
                    _this.removeEventListener(exports.SocketConnection.ERROR);
                    throw error;
                }
            }
            _this.emitter.on(exports.SocketConnection.CONNECT, function () {
                try {
                    _this.connection.send(reqMiddleware(JSON.stringify(payload)));
                }
                catch (error) {
            ...
            _this.emitter.on(exports.SocketConnection.ERROR, reject);
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.messenger.send(exports.RPCMethod.GetPastLogs, __spread(this.options), this.messenger.chainType, this.shardID)];
                    case 2:
                        getPastLogs = _a.sent();

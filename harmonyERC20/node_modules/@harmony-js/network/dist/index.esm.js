...
import { isWs, isObject, isArray, defaultConfig, isHttp, HarmonyCore, isString, isHex, hexToNumber } from '@harmony-js/utils';
...
var WSProvider = /** @class */ (function (_super) {
    ...
    WSProvider.prototype.createWebsocketProvider = function (url, options) {
        ...
        if (typeof window !== 'undefined' && window.WebSocket) {
            ...
            return new w3cwebsocket(url, options.protocol, undefined, headers_1, undefined, options.clientConfig);
        }
    };
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this.connected) {
                try {
                    ...
                    _this.removeEventListener(SocketConnection.ERROR);
                    throw error;
                }
            }
            _this.emitter.on(SocketConnection.CONNECT, function () {
                try {
                    _this.connection.send(reqMiddleware(JSON.stringify(payload)));
                }
                catch (error) {
            ...
            _this.emitter.on(SocketConnection.ERROR, reject);
        });
    };
...
var ResponseMiddleware = /** @class */ (function () {
    ...
    Object.defineProperty(ResponseMiddleware.prototype, "getResult", {
        get: function () {
            return isObject(this.result) ? __assign(__assign({}, this.result), { responseType: 'result' }) : this.result;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ResponseMiddleware.prototype, "getError", {
        get: function () {
            return isObject(this.error) ? __assign(__assign({}, this.error), { responseType: 'error' }) : this.error;
        },
        enumerable: true,
        configurable: true
    });
...
var Messenger = /** @class */ (function (_super) {
    ...
    function Messenger(provider, chainType, chainId, config) {
        if (chainType === void 0) { chainType = defaultConfig.Default.Chain_Type; }
        ...
        _this.JsonRpc = new JsonRpc();
        // set Network ID
        _this.setNetworkID(defaultConfig.Default.Network_ID);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.messenger.send(RPCMethod.GetPastLogs, __spread(this.options), this.messenger.chainType, this.shardID)];
                    case 2:
                        getPastLogs = _a.sent();
...
export { BaseProvider, SocketConnection, SocketState, EmittType, BaseSocket, fetchRPC, HttpProvider, WSProvider, Emitter, ProviderType, Provider, Messenger, ResponseMiddleware, JsonRpc, DEFAULT_TIMEOUT, DEFAULT_HEADERS, performRPC, composeMiddleware, RPCMethod, RPCErrorCode, BaseBlockTracker, timeout, PollingBlockTracker, SubscribeBlockTracker, SubscriptionMethod, LogSub, NewHeaders, NewPendingTransactions, Syncing, getResultForData, getRawForData, onResponse, MiddlewareType, SubscribeReturns };

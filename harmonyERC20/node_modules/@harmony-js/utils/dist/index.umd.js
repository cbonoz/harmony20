...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bn.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'bn.js'], factory) :
  (factory((global.harmonyUtils = {}),global.bn.js));
}(this, (function (exports,BN) { 'use strict';
  ...
  var isBlockNumber = function (obj) {
      var blockParams = [
          exports.DefaultBlockParams.earliest,
          exports.DefaultBlockParams.pending,
          exports.DefaultBlockParams.latest,
      ];
      if (!isString(obj)) {
  ...
  ***************************************************************************** */
  ...
  var unitMap = new Map([
      [exports.Units.wei, '1'],
      [exports.Units.Kwei, '1000'],
      [exports.Units.Mwei, '1000000'],
      [exports.Units.Gwei, '1000000000'],
      [exports.Units.szabo, '1000000000000'],
      [exports.Units.finney, '1000000000000000'],
      [exports.Units.ether, '1000000000000000000'],
      [exports.Units.one, '1000000000000000000'],
      [exports.Units.Kether, '1000000000000000000000'],
      [exports.Units.Mether, '1000000000000000000000000'],
      [exports.Units.Gether, '1000000000000000000000000000'],
      [exports.Units.Tether, '1000000000000000000000000000000'],
  ]);
  /** @hidden */
  var DEFAULT_OPTIONS = {
      pad: false,
  ...
  var Unit = /** @class */ (function () {
      ...
      Unit.prototype.asOne = function () {
          this.wei = toWei(this.unit, exports.Units.one);
          return this;
      };
      ...
      Unit.prototype.toOne = function () {
          if (this.wei) {
              return fromWei(this.wei, exports.Units.one);
          }
          else {
              throw new Error('error transforming');
          }
  ...
  var defaultConfig = {
      Default: {
          ...
          Chain_Type: exports.ChainType.Harmony,
          Chain_URL: 'http://localhost:9500',
          Network_ID: 'Local',
      },
      DefaultWS: {
      ...
      Object.defineProperty(HarmonyCore.prototype, "chainPrefix", {
          get: function () {
              switch (this.chainType) {
                  ...
                  case exports.ChainType.Harmony: {
                      return 'hmy';
                  }
                  default: {
                      return 'hmy';

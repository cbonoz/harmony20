...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@harmony-js/crypto'), require('@harmony-js/utils'), require('@harmony-js/transaction'), require('@harmony-js/network'), require('@harmony-js/account')) :
    typeof define === 'function' && define.amd ? define(['exports', '@harmony-js/crypto', '@harmony-js/utils', '@harmony-js/transaction', '@harmony-js/network', '@harmony-js/account'], factory) :
    (factory((global.harmonyContract = {}),global['@harmony-js/crypto'],global['@harmony-js/utils'],global['@harmony-js/transaction'],global['@harmony-js/network'],global['@harmony-js/account']));
}(this, (function (exports,crypto,utils,transaction,network,account) { 'use strict';
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            // tslint:disable-line
                            return [4 /*yield*/, this.wallet.messenger.send(network.RPCMethod.Call, [sendPayload, blockNumber], 
                                // tslint:disable-line
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            // tslint:disable-line
                            return [4 /*yield*/, this.wallet.messenger.send(network.RPCMethod.EstimateGas, [params])];
                        case 1:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            result = _a.sent();
                            if (result.receipt && result.txStatus === transaction.TxStatus.CONFIRMED) {
                                if (this.methodKey === 'contractConstructor') {

...
import { BN, throwError, INVALID_ARGUMENT, arrayify, hexlify, padZeros, concat, toChecksumAddress, checkArgumentCount, checkNormalize, checkNew, bytesPadRight, keccak256, getAddress, isHexString } from '@harmony-js/crypto';
import { hexToBN, defineReadOnly, isObject, isArray, hexToNumber, numberToHex, isString, isAddress } from '@harmony-js/utils';
import { TransactionFactory, TxStatus } from '@harmony-js/transaction';
import { RPCMethod, getResultForData, LogSub } from '@harmony-js/network';
...
/** @hidden */
var MaxUint256 = hexToBN('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff');
///////////////////////////////
/** @hidden */
...
function parseBytes32String(bytes) {
    var data = arrayify(bytes) || new Uint8Array();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        options = __assign(__assign(__assign({}, this.contract.options), { data: this.transaction.txParams.data }), options);
                        ...
                        this.transaction = this.transaction.map(function (tx) {
                            return __assign(__assign(__assign({}, tx), options), { from: from_1 || tx.from, gasPrice: options ? options.gasPrice : tx.gasPrice, gasLimit: gasLimit_2 || tx.gasLimit, nonce: Number.parseInt(hexToNumber(nonce_1), 10) });
                        });
                        ...
                        // tslint:disable-line
                        return [4 /*yield*/, this.wallet.messenger.send(RPCMethod.Call, [sendPayload, blockNumber], 
                            // tslint:disable-line
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = getResultForData;
                        // tslint:disable-line
                        return [4 /*yield*/, this.wallet.messenger.send(RPCMethod.EstimateGas, [params])];
                    case 1:
    ...
    ContractMethod.prototype.createTransaction = function () {
        if (this.wallet.messenger) {
            ...
            var txObject = __assign(__assign(__assign({}, this.contract.options), this.params[0]), { to: this.methodKey === 'contractConstructor'
                    ? '0x'
                    : getAddress(this.contract.address).checksum, data: this.encodeABI() });
            // tslint:disable-line
...
export { toUtf8Bytes, toUtf8String, formatBytes32String, parseBytes32String, Contract, ContractFactory, AbiCoder$1 as AbiCoder };

...
import { ResponseMiddleware, WSProvider, NewPendingTransactions, NewHeaders, LogSub, Syncing, Provider, HttpProvider, Messenger, RPCMethod } from '@harmony-js/network';
import * as utils from '@harmony-js/utils';
import { assertObject, defaultConfig, HarmonyCore, hexToNumber, ChainType, ChainID, Unit, isBech32Address } from '@harmony-js/utils';
import * as crypto from '@harmony-js/crypto';
import { getAddress, fromBech32, HRP } from '@harmony-js/crypto';
...
import { Wallet, Account, HDNode } from '@harmony-js/account';
...
var Blockchain = /** @class */ (function () {
    ...
    Blockchain.prototype.getBalance = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.messenger.send("hmy_getBalance" /* GetBalance */, [getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID)];
                    case 1:
                        result = _d.sent();
    ...
    Blockchain.prototype.getCode = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.messenger.send("hmy_getCode" /* GetCode */, [getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID)];
                    case 1:
                        result = _d.sent();
                        return [2 /*return*/, this.getRpcResult(result)];
                }
    ...
    Blockchain.prototype.getStorageAt = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.messenger.send("hmy_getStorageAt" /* GetStorageAt */, [getAddress(address).checksum, position, blockNumber], this.messenger.chainPrefix, shardID)];
                    case 1:
                        result = _d.sent();
                        return [2 /*return*/, this.getRpcResult(result)];
                }
    ...
    Blockchain.prototype.getTransactionCount = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.messenger.send("hmy_getTransactionCount" /* GetTransactionCount */, [getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID)];
                    case 1:
                        result = _d.sent();
                        return [2 /*return*/, this.getRpcResult(result)];
                }
    ...
    Blockchain.prototype.estimateGas = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.messenger.send("hmy_estimateGas" /* EstimateGas */, [{ to: getAddress(to).checksum, data: data }], this.messenger.chainPrefix, shardID)];
                    case 1:
                        result = _c.sent();
                        return [2 /*return*/, this.getRpcResult(result)];
                }
                ...
                switch (_c.label) {
                    ...
                    case 9: return [4 /*yield*/, this.provider.send(newArgs, function (err, res) {
                            try {
                                ...
                                var response = _this.resolveResult(res);
                                if (new Unit(response.result.gasLimit)
                                    .asWei()
                                    .toWei()
                                    .gt(new Unit(_this.gasLimit).asWei().toWei())) {
                                    response.result.gasLimit = "0x" + new Unit(_this.gasLimit)
                                        .asWei()
                                        .toWei()
                                        .toString('hex');
                                }
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, this.messenger.send(RPCMethod.GetTransactionCount, [getAddress(extensionAccount.address).checksum, blockNumber], this.messenger.chainPrefix, typeof transaction.txParams.shardID === 'string'
                                        ? Number.parseInt(transaction.txParams.shardID, 10)
                                        : transaction.txParams.shardID)];
                            case 2:
                                nonce = _a.sent();
...
export { Harmony, Blockchain, TruffleProvider, ExtensionType, HarmonyExtension, UrlType };

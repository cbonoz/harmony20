    ...
    var TruffleProvider = /** @class */ (function (_super) {
        ...
        function TruffleProvider(provider, hdOptions, chainOptions, transactionOptions) {
            ...
            if (chainOptions === void 0) { chainOptions = {
                ...
                chainId: utils.ChainID.HmyLocal,
            }; }
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.messenger.send(network.RPCMethod.GetTransactionCount, [crypto.getAddress(extensionAccount.address).checksum, blockNumber], this.messenger.chainPrefix, typeof transaction$$1.txParams.shardID === 'string'
                                            ? Number.parseInt(transaction$$1.txParams.shardID, 10)
                                            : transaction$$1.txParams.shardID)];
                                case 2:
                                    nonce = _a.sent();
